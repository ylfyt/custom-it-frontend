...
export type RegularProductFragment = {
	...
	storeId: string;
	imageUrl: string;
	comments: Array<{ __typename?: 'Comment'; id: string; text: string; createAt: string; user: { __typename?: 'User'; id: string; username: string } }>;
	store: { __typename?: 'Store'; id: string; username: string; name: string; address: string };
};
